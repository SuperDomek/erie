...
class TrackDirectorSubmissionDAO extends DAO {
	...
	function updateTrackDirectorSubmission(&$trackDirectorSubmission) {
		...
		// Update director decisions; first two REVIEW_STAGE_ABSTRACT, REVIEW_STAGE_PRESENTATION
		// the next are more rounds of review
		...
		if ($trackDirectorSubmission->getPaperId()) {
			...
			$paper->setPages($trackDirectorSubmission->getPages());

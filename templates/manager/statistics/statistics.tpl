...
<table width="100%" class="data">
	<tr valign="top">
		<td width="30%" class="label"><label for="statItemsPublished">{translate key="manager.statistics.statistics.itemsPublished"}</label></td>
		<td width="70%" class="value">{$paperStatistics.numPublishedSubmissions}</td>
	</tr>
	<tr valign="top">
		<td width="30%" class="label"><label for="statNumSubmissions">{translate key="manager.statistics.statistics.numSubmissions"}</label></td>
		<td width="70%" class="value">{$paperStatistics.numSubmissions}</td>
	</tr>
	<tr valign="top">
		<td width="30%" class="label"><label for="statPeerReviewed">{translate key="manager.statistics.statistics.peerReviewed"}</label></td>
		<td width="70%" class="value">{$limitedPaperStatistics.numReviewedSubmissions}</td>
	</tr>
	<tr valign="top">
		<td width="30%" class="label">&nbsp;&nbsp;<label for="statCountAccept">{translate key="manager.statistics.statistics.count.accept"}</label></td>
	...
	<tr valign="top">
		<td width="30%" class="label">&nbsp;&nbsp;<label for="statCountDecline">{translate key="manager.statistics.statistics.count.decline"}</label></td>
	...
	<tr valign="top">
		<td width="30%" class="label">&nbsp;&nbsp;<label for="statDaysPerReview">{translate key="manager.statistics.statistics.daysPerReview"}</label></td>
	...
	<tr valign="top">
		<td width="30%" class="label"><label for="statRegisteredUsers">{translate key="manager.statistics.statistics.users"}</label></td>
		<td width="70%" class="value">{$userStatistics.totalUsersCount}</td>
	</tr>
	<tr valign="top">
		<td width="30%" class="label"><label for="statRegisteredReaders">{translate key="manager.statistics.statistics.readers"}</label></td>
		<td width="70%" class="value">{$userStatistics.reader|default:"0"}</td>
	</tr>

	<tr valign="top">
		<td colspan="2" class="label"><label for="statRegistrations">{translate key="manager.statistics.statistics.registrations"}</label></td>
	</tr>

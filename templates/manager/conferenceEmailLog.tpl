 ...
 *}
{strip}
{assign var="pageTitle" value="event.emailLog"}
{include file="common/header.tpl"}
{/strip}

<div id="emailLogEntries">
<h3>{translate key="conference.history.conferenceEmailLog"}</h3>
<p>
// Seznam paperů v jakékoli fázi<br />
	// Každý paper proklik na vlastní seznam mailů s počtem emailů<br />
		// getCount() [DAOResultFactory]
